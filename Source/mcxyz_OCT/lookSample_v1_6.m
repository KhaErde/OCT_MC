...
%lambda_start = 1300e-7; %%%%CHOOSE VALUE%%%%
%lambda_stop = 1320e-7; %%%%CHOOSE VALUE%%%%
...
%rn(1:samplePoints,1) = 1.4409;
rn(1:samplePoints,1) = 1;
...
z = z/100;
figure();
plot(z,db(mean(OCT,2)),'LineWidth',2)
axis([0 3e-3 -80 180])
temp = strsplit(myname,'_');
name = strjoin(temp,{'-'});
title(strcat('OCT A-line of phantom:',name))
ylabel('Intensity [dB]')
xlabel('Position [cm]')
toc
